...
#memoPopup input[type="submit"], #memoPopup button,
#deptMemoPopup input[type="submit"], #deptMemoPopup button {
    width: 45%;
    padding: 10px;
    margin: 5px;
    border: none;
...
<body>
	...
	<%@ include file="/WEB-INF/views/header.jsp"%>
	 ...
	 <div id="popupOverlay" onclick="closePopup('memoPopup'); closePopup('deptMemoPopup');"></div>
	 ...
	 <div id="memoPopup">
        ...
        <form action="mymemoWrite" method="post">
            ...
            <input type="text" name="mymemocontent" required><br>
    ...
    <div id="deptMemoPopup">
        ...
        <form action="deptmemoWrite" method="post">
            ...
            <label for="content">내용:</label>
            <input type="text" name="deptmemocontent" required><br>
            <div id="buttonContainer">
                <input type="submit" value="저장">
						...
						<div class="board_memo1">
							...
							<ul>
								<c:forEach items="${memo1}" var="dto1">
									<li>${dto1.content}&nbsp;${dto1.createdate}<button
